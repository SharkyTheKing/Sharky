...
"""
Full credit to Bakersbakebread for this file.

This was originally used for Fortnite's discord,
though I kept the code (as I made it, except for this file and various functions) and decided to make it a public cog.
"""
...
class AuditLogging:
    ...
    async def get_public_log_embed(entry: PublicLogEntry) -> discord.Embed:
        ...
        embed = discord.Embed(title="Filtered message", color=discord.Color.gold())
